...
app_region = os.getenv('FLY_REGION', 'iad')
app_org = os.getenv('FLY_ORG')
app_port = os.getenv('FLY_PORT', 5121)
app_kill_signal = os.getenv('FLY_KILL_SIGNAL', 'SIGTERM')
app_kill_timeout = os.getenv('FLY_KILL_TIMEOUT', 300)
fly_cpus = os.getenv('FLY_CPUS', 0.25)
fly_memory = os.getenv('FLY_MEMORY', 128)
dockerfile_path = os.getenv('DOCKERFILE_PATH', 'Dockerfile')
app_volumes = os.getenv('FLY_VOLUMES', [])
